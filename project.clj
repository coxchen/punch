(defproject punch "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "punch.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main punch.application
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                :figwheel {:on-jsload "punch.system/reset"}

                :compiler {:main cljs.user
                           :asset-path "js/compiled/out"
                           :output-to "dev-target/public/js/compiled/punch.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "dev-target/public/js/compiled/testable.js"
                           :main punch.test-runner
                           :optimizations :none}}

               {:id "min"
                :source-paths ["src/cljs" "src/cljc"]
                :jar true
                :compiler {:main punch.system
                           :output-to "resources/public/js/compiled/punch.js"
                           :output-dir "target"
                           :source-map-timestamp true
